...
import (
	...
	basekeeper "github.com/datachainlab/cross/x/atomic/protocol/base/keeper"
...
type Keeper struct {
	...
	cm          contracttypes.ContractManager
...
) (*contracttypes.ContractCallResult, *types.PacketAcknowledgementCall, error) {
